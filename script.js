...
const COMMANDS = {
  ...
  education:
    "Bachelors of Electronics and communication engineering pursuing  <br> Diploma in Electronics and communication engineering ",
  experience:'<span class="code"> Working as a Content Creator at BePractical </span><br> Security Researcher | Bug Hunter on the Various Platforms - Present<br> ',
  certifications: 
    " MCEH - Metaxone Certified Ethical Hacker ",
  contact:
    "You can contact me on Linkedin and or via the mail:<br><a href='https://www.linkedin.com/in/asifpathan48/' class='success link'>Linkedin</a>, <a href='mailto:bughunterasif@gmail.com' class='success link'>Email</a>,"
};
